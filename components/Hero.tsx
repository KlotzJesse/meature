export const Hero = () => {
  return (
    <div className="relative flex flex-col-reverse py-16 lg:pt-0 lg:flex-col lg:pb-0 mt-14 mb-56">
      <div className="w-2/3 absolute -z-0 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
        <img
            src="/hero.svg"
            alt=""
            className='w-full'
