export const ContentLeft = () => {
  return (
    <div className="relative flex flex-col py-0 lg:pt-0 lg:flex-col lg:pb-0 bg-primary">
      ...
      <div className="left-0 right-0 flex flex-col items-center w-full max-w-xl px-4 mx-auto text-center -bottom-20 md:absolute md:px-0 lg:px-8 lg:max-w-screen-xl">
